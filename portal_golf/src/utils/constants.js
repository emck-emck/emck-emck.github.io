...
export const OFFSET_PORTAL_BALL = 3;
export const OFFSET_PORTAL_PLACE = 5;
...
export const ASSET_FILEPATH_LEADERBOARD = './public/assets/images/leaderboard/';
...
export const PORTAL_ORANGE = 'oportal';
